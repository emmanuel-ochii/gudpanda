...
// images
import logo3 from '@/assets/guest/img/logo/logo-3.png';
import logo2 from '@/assets/guest/img/logo/logo-2.png';
import footer1 from '@/assets/guest/img/icon/footer-1.png';
import footer2 from '@/assets/guest/img/icon/footer-2.png';
import footer3 from '@/assets/guest/img/icon/footer-3.png';
import footer4 from '@/assets/guest/img/icon/footer-4.png';
import footerImg1 from '@/assets/guest/img/images/footer-img-1.png';
</script>
