            ...
            <div class="row gy-lg-0 gy-4 justify-content-center">
                <div class="col-lg-3 col-md-4">
                    <div class="hero-list-wrap">
                        <ul class="hero-list">
                            <li><a href="#"><i class="fa-regular fa-plus"></i>Breakfast & Dairy</a></li>
                            <li><a href="#"><i class="fa-regular fa-plus"></i>Meat & Fish</a></li>
                            <li><a href="#"><i class="fa-regular fa-plus"></i>Fresh Fruit</a></li>
                            <li><a href="#"><i class="fa-regular fa-plus"></i>Fresh Vegetables</a></li>
                            <li><a href="#"><i class="fa-regular fa-plus"></i>Dairy Eggs</a></li>
                            <li><a href="#"><i class="fa-regular fa-plus"></i>Milk & Cream</a></li>
                            <li><a href="#"><i class="fa-regular fa-plus"></i>Bread & Bakery</a></li>
                            <li><a href="#"><i class="fa-regular fa-plus"></i>Grocery</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6 col-md-8">
                    <div class="hero-item" data-background="frontend/img/bg-img/hero-item-bg.png">
                ...
                <div class="col-lg-3 col-md-5">
                    <div class="discount-item food-discount hero-discount"
                        data-background="frontend/img/images/hero-discount.png">
                        <div class="content">
            ...
            <div class="row food-wrap gy-lg-0 gy-4 justify-content-center">
                <div class="col-lg-2 col-md-4">
                    <div class="food-item text-center">
                        <div class="food-img">
                            <img src="frontend/img/images/food-1.png" alt="food">
                        </div>
                ...
                <div class="col-lg-2 col-md-4">
                    <div class="food-item text-center">
                        <div class="food-img">
                            <img src="frontend/img/images/food-2.png" alt="food">
                        </div>
                ...
                <div class="col-lg-2 col-md-4">
                    <div class="food-item text-center">
                        <div class="food-img">
                            <img src="frontend/img/images/food-3.png" alt="food">
                        </div>
                ...
                <div class="col-lg-2 col-md-4">
                    <div class="food-item text-center">
                        <div class="food-img">
                            <img src="frontend/img/images/food-4.png" alt="food">
                        </div>
                ...
                <div class="col-lg-2 col-md-4">
                    <div class="food-item text-center">
                        <div class="food-img">
                            <img src="frontend/img/images/food-5.png" alt="food">
                        </div>
                ...
                <div class="col-lg-2 col-md-4">
                    <div class="food-item text-center">
                        <div class="food-img">
                            <img src="frontend/img/images/food-6.png" alt="food">
                        </div>
            ...
            <div class="row gy-lg-0 gy-4">
                <div class="col-lg-6">
                    <div class="discount-item food-discount" style="--rr-color-theme-primary: #67B02E">
                        ...
                        <div class="men"><img src="frontend/img/images/food-discount-1.png" alt="img"></div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="discount-item food-discount food-discount-2" style="--rr-color-theme-primary: #67B02E">
                        ...
                        <div class="men"><img src="frontend/img/images/food-discount-2.png" alt="img"></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="item-wrap">
                        <div class="discount-item food-discount">
                            ...
                            <div class="men"><img src="frontend/img/images/food-discount-3.png" alt="img"></div>
                        </div>
                        <div class="discount-item food-discount" style="--rr-color-theme-primary: #67B02E">
                            <div class="content">
                                <span>-45 % Offer</span>
                            ...
                            <div class="men"><img src="frontend/img/images/food-discount-4.png" alt="img"></div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-2 col-lg-3 col-md-6">
    ...
    <div class="discount-cta mb-60">
        <div class="container p-0">
            <div class="discount-cta-wrap text-center pt-35 pb-35"
                data-background="frontend/img/bg-img/discount-cta-bg.jpg">
