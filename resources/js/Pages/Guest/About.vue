<template>
    ...
    <section class="page-header">
        <div class="shape">
            <img :src="pageHeaderShape" alt="shape">
            </div>
        <div class="container">
...
import aboutImg1 from '@/assets/guest/img/images/about-img-1.jpg';
import service1 from '@/assets/guest/img/service/service-1.png';
import service2 from '@/assets/guest/img/service/service-2.png';
import service3 from '@/assets/guest/img/service/service-3.png';
import testiShape from '@/assets/guest/img/shapes/testi-shape.png';
import testiAuthor from '@/assets/guest/img/images/testi-author.png';
import testiAuthor2 from '@/assets/guest/img/images/testi-author-2.png';
import testiAuthor3 from '@/assets/guest/img/images/testi-author-3.png';
